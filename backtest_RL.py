...
if __name__=='__main__':
    ...
    parser.add_argument('--dataset', default='Cleaned_Data/SPY-RL.csv', help='Full Dataset to backtest on')
    ...
    backtest(fl=data,model_name=args.model)